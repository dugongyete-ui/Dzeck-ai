...
import { Loader2, CheckCircle, AlertCircle, Brain, Wrench, Zap, RefreshCw } from 'lucide-react'
...
const statusConfig = {
  ...
  'self-correcting': { icon: RefreshCw, text: 'Self-Correcting...', color: 'text-amber-500', bg: 'bg-amber-100 dark:bg-amber-900/30', spin: true },
...
function StatusIndicator({ status }) {
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${config.bg} ${config.color} transition-all duration-300`}>
